...
- Version(0.5Byte) : IP프로토콜의 버전 무조건 4가 온다. 6쓴다고 IPv6아니다. IPv6은 구조 자체가 다르다
...
- 조각화 안나게 전송
  ...
  protocol : 다음 프로토콜 icmp프로토콜 0으로 나타낸다  
  checksum : 사용 안함 0.
